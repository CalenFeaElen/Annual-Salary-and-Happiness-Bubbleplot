...
#print(f"Countries with smallest average wages: {wage_average_per_country.nsmallest(10)}")
#print(f"Countries with largest average happiness scores: {happiness_average_per_country.nlargest(10)}")
#print(f"Countries with smallest average happiness scores: {happiness_average_per_country.nsmallest(10)}")
